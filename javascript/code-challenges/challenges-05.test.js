...
//https://www.teamsimmer.com/2023/02/14/how-can-i-put-the-array-reduce-method-to-use-in-technical-marketing/
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((total, current) => {
    const currentItemValue = current.purchasePrice;
...
const returnNames = (arr) => {
  ...
  return arr.reduce((accumulator, entity) => {
    accumulator.push(entity.name);
    return accumulator; // jaye helped with this line. i originally had return on the above line.
  }, []);
};
...
//john cokos' example from demo video
