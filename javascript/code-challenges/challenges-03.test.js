...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  const newArray = arr.filter(obj => obj.baseStat > minBaseStat);
  return newArray;
};
...
------------------------------------------------------------------------------------------------ */
//with LACEY WASHINGTON's help!
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  const newArray = getBaseStatGreaterThan(arr, minBaseStat).map(obj => obj.stat.name);
  return newArray;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  const newArray = arr.filter(obj => !obj.children);
  return newArray;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  const newArray = arr.filter(element => typeof(element) === 'number').map(num => num % 2 === 0 ? 'even' : 'odd');
  return newArray;
};
