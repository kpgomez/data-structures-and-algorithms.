...
const maxInArray = (arr) => {
  // ternary says if acc is greater than currentValue return acc otherwise replace acc with currentValue
  const maxValue = arr.reduce((acc, currentValue) => acc > currentValue ? acc : acc = currentValue);
  return maxValue;
};
...
const checkValues = (obj, value) => {
  ...
  return objectValues.includes(value);
};
